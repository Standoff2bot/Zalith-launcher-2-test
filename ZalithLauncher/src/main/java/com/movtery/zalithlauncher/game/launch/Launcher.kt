...
abstract class Launcher(
    ...
    protected open fun progressFinalUserArgs(
        ...
        // Purge any previous G1GC tuning flags to avoid duplicates or stale values
        args.purgeArg("-XX:+UnlockExperimentalVMOptions")
        args.purgeArg("-XX:MaxGCPauseMillis")
        args.purgeArg("-XX:G1NewSizePercent")
        args.purgeArg("-XX:G1ReservePercent")
        args.purgeArg("-XX:G1HeapRegionSize")
        args.purgeArg("-XX:G1MixedGCCountTarget")
        args.purgeArg("-XX:InitiatingHeapOccupancyPercent")
        args.purgeArg("-XX:+UseStringDeduplication")
        args.purgeArg("-XX:+AlwaysPreTouch")
